...
<?php include_once('completoMenuSup.php');	?>
  ...
  <?php include_once('aguaXamb24h.php'); ?>
  <div id="drawChartaguaXamb24h" style="width: 900px; height: 500px;"></div>
<br>
  <?php include_once('aguaXamb30d.php'); ?>
  <div id="drawChartaguaXamb30d" style="width: 900px; height: 500px;"></div>

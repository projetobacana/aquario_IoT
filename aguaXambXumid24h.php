...
where data BETWEEN CURRENT_DATE()-30 AND CURRENT_DATE()+1 ) x 
...
?>
  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChartaguaXambXumid24h);


      function drawChartaguaXambXumid24h() {
        ...
        var optionsaguaXambXumid24h = {
          title: 'Agua x Ambiente x Umidade nos últimos 2 dias',
          curveType: 'function',
        ...
        var chartaguaXambXumid24h = new google.visualization.ComboChart(document.getElementById('drawChartaguaXambXumid24h'));

        chartaguaXambXumid24h.draw(data, optionsaguaXambXumid24h);
      }

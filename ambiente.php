...
<html>
 ...
 <?php include_once('completoMenuSup.php');	?>
  ...
  <?php include_once('ambiente24h.php'); ?>
  <div id="drawChartambiente24h" style="width: 900px; height: 500px;"></div>
<br>
  <?php include_once('ambiente30d.php'); ?>
  <div id="drawChartambiente30d" style="width: 900px; height: 500px;"></div>
  <br>
  <?php include_once('ambiente30dMM.php'); ?>
  <div id="drawChartambiente30dMM" style="width: 900px; height: 500px;"></div>
